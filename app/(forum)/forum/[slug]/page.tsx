...
export default async function CommunityPage({
  ...
  return (
    <div className="page-enter flex flex-col gap-10" >
      {/* Banner card */}
      <div className="bg-paper-2 p-[clamp(20px,_4vw,_32px)_clamp(18px,_4vw,_36px)_24px] shadow-card" style={{ border: "1.5px solid var(--ink)" }}>
        {/* Breadcrumb */}
        ...
        <div className="relative flex flex-col gap-[14px]">
          ...
          <div className="flex gap-4">
            <Link
              ...
              className="bg-paper-2 text-ink-2 py-[7px] px-[14px] text-base font-semibold no-underline" style={{ border: "1.5px solid var(--ink)" }}
            >
              Mod tools
            </Link>
            <Link
      ...
      <div className="flex flex-col gap-5">
        ...
        {threads.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-[56px] px-[24px] bg-paper shadow-card gap-6" style={{ border: "1.5px solid var(--ink)" }}>
