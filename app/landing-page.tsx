...
import { ArchitecturePitch } from "@/components/architecture/architecture-pitch";
 ...
 * unmounted).
 *
 * Visual rules in /app/globals.css under `.ed-public-nav*` / `.ed-hero*`
 * / `.ed-module-card*` / `.ed-banner-dark` / `.ed-public-footer`.
 */
    ...
    <NotificationsProvider>
      <div className="ed-landing">
        ...
        <main id="main" tabIndex={-1} className="ed-landing-main">
          <LandingHero />
          {/* Architecture pitch leads the page as the thesis statement;
              modules are the proof points, bio is who built it. */}
          <ArchitecturePitch />
