      ...
      <header style={{
        ...
        {mobileMenuOpen && (
          <div style={{ borderTop: "1px solid var(--border)", padding: "16px 24px", display: "flex", flexDirection: "column", gap: "8px" }}>
            {["/about", "/communities", "/households"].map((href, i) => (
              <Link key={href} href={href} onClick={() => setMobileMenuOpen(false)} style={{
                padding: "10px 12px", borderRadius: "8px", fontSize: "14px", color: "var(--text-2)", textDecoration: "none",
              }}>
                {["About", "Forum", "Bills"][i]}
              </Link>
            ))}
            <div style={{ height: "1px", background: "var(--border)", margin: "4px 0" }} />
            <Link href="/login" onClick={() => setMobileMenuOpen(false)} style={{ padding: "10px 12px", borderRadius: "8px", fontSize: "14px", color: "var(--text-2)", textDecoration: "none" }}>Sign in</Link>
      ...
      <section style={{ padding: "80px 32px", background: "var(--bg-2)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            onMouseEnter={e => (e.currentTarget as HTMLElement).style.background = "oklch(63% 0.22 252 / 0.18)"}
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "16px" }}>
          ...
          <nav style={{ display: "flex", gap: "16px" }}>
            {[
              ...
              <Link key={item.href} href={item.href} style={{ fontSize: "13px", color: "var(--text-3)", textDecoration: "none", transition: "color 110ms" }}
