...
import {
  householdDetailHeadline,
  householdDetailDeck,
} from "@/lib/household/editorial-copy";
...
export default async function HouseholdPage({ params }: { params: { id: string } }) {
  ...
  const yourShare = monthlyObligations !== null && memberCount > 0
    ? monthlyObligations / memberCount
    : null;
  ...
  return (
    <div className="page-enter flex flex-col gap-6">
      <Link href="/household" className="ed-label-muted no-underline hover:text-red self-start">← All households</Link>
        ...
        aside={[
          {
            ...
            value: monthlyObligations !== null ? fmt0(monthlyObligations, household.currencyCode) : "—",
      ...
      <section className="flex flex-col gap-5">
        ...
        <div className="flex justify-end gap-3 -mt-2">
          <Btn variant="secondary" size="sm" iconLeft={<Icon name="filter" size={13} strokeWidth={2} />}>Filter</Btn>
        </div>
        <ExpensesList
