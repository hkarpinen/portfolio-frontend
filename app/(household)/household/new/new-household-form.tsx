...
// Curated timezone list. Intl.supportedValuesOf('timeZone') exists in Node 18+
// and modern browsers but isn't universally supported across Next.js edge
// environments, so a static curated set lives here. Expand as needed.
const TIMEZONES = [
  "America/New_York",
  "America/Chicago",
  "America/Denver",
...
/**
 * Audit §3.3 — extracted as a client island so the page shell (back link,
 * SectionHeader) stays server-rendered. Reduces the JS payload on every
 * visit even before the user starts typing.
 */
