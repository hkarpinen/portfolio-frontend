...
const NAV_ITEMS = [
  ...
  { label: "Connected accounts",  href: "/settings/connections",    matchPrefix: "/settings/connections" },
...
export function SettingsNav() {
  ...
  return (
    <nav className="ed-settings-nav" aria-label="Settings sections">
      ...
      <Link href="/settings/security#danger" className="ed-settings-nav-item ed-settings-nav-delete">
        Delete account
      </Link>
    </nav>
  );
